...
Sobre $\QQ$ los posibles grupos de torsion fueron caracterizados completamente por Mazur \cite{Mazur1977} y luego para extensiones cuadraticas por Kamienny \cite{Kamienny1992} y Kenku-Momose \cite{KenkuMomose1988}. Más aún, para $K=\QQ(i)$ y $K=\QQ(\omega)$, Najman \cite{Najman2010} redujo la lista de posibles grupos.
