...
En la introduccion utilizamos una curva especifica que nos permitia encontrar mas facilmente la conexion entre un punto racional y los elementos de $\QmodT$, pero para que esta asignacion cumpla las propiedades que queriamos, secretamente estabamos usando que teniamos un punto de 3-torsion o, más especificamente, una isogenia de grado 3.

Supongamos que tenemos una curva $E$ con una isogenia $\phi:E\to E'$ de grado $m$, en particular $\hat{phi} \circ \phi = [m]$. En conjunto con la secuencia exacta corta 
\[
0 \to E(K)[m] \to E(\bar{K}) \longrightarrow E(\bar{K}) \to 0
\]
